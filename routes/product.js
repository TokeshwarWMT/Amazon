...
router.put('/user/update_Product/:productId/:sellerId', userAuth, userProduct.update_Product);
router.delete('/user/delete_Product/:productId/:sellerId', userAuth, userProduct.delete_Product);
